        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="mb-0">Edit Data Kampung</h3> <small class="text-muted float-end">
                </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <select name="kecamatan_id" id="kecamatan_id" class="form-control select2">
                                    <option value="{{ $kampung->kecamatan_id }}" selected>
                                        {{ $kampung->kecamatan->nama_kecamatan }}
                                    </option>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <select name="nagari_id" id="nagari_id" class="form-control select2">
                                    <option value="{{ $kampung->nagari_id }}" selected>{{ $kampung->nagari->nama_nagari }}
                                    </option>
                                </select>
                                @error('nagari_id')
                                    <div class="invalid-feedback">
