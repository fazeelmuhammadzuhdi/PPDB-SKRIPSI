            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <img src="{{ Storage::url($dataPindahTugas->siswa->foto ?? '') }}" alt="" width="150"
                            class="mt-3">
                        <table class="table table-striped table-sm mt-2 mb-2">
                            <thead>
                                        ...
                                        <td>:
                                            <span>
                                                @if ($dataPindahTugas->status == 1)
                                                    <span class="badge bg-success">Lulus</span>
                                                @elseif ($dataPindahTugas->status == 2)
                                                    <span class="badge bg-success">Belum Lulus</span>
                                                @else
                                                    <span class="badge bg-success">Dalam Seleksi</span>
                                                @endif
                                            </span>
                                        </td>
