...
<div class="modal fade" id="editModalKategori" tabindex="-1" aria-labelledby="editModalKategoriLabel" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <form action="{{ route('penghasilan.update') }}" method="POST" id="editFormKategori">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalKategoriLabel">Edit Data Penghasilan</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                <label for="editModalKategoriLabel">Penghasilan</label>
