                        ...
                        <div class="card-body">
                            <div class="alert alert-success d-flex" role="alert">
                                ...
                                <div class="d-flex flex-column ps-1">
                                    ...
                                    <p class="mt-2"><a href="{{ route('cek_hasil_kelulusan') }}" target="_blank">Klik
                                            Disini
                                            Untuk Cetak Bukti Hasil Kelulusan</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="d-flex flex-column ps-1">
                                    <h2 class="alert-heading d-flex justify-content-center align-items-center fw-bold mb-1">
                                        ...
                                        @elseif ($cekLulusJalurPindahTugas?->status == 2)
                                            Maaf, Anda Tidak Lulus Di Sekolah
                                            {{ $cekLulusJalurPindahTugas->sekolah->nama }}
                                        @endif
                                    </h2>
                                    {{-- <p class="mt-2"><a href="{{ route('cek_hasil_kelulusan') }}" target="_blank">Klik Disini
                                        Untuk Cetak
                                        Bukti Hasil Kelulusan</a></p> --}}
                                    <h1 class="mt-2 text-danger">TETAP SEMANGAT 🙂</h1>
                                </div>
                            </div>
                        </div>
                    </div>
