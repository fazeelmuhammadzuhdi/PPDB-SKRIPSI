...
class SiswaBelumLulusJalurPindahTugas implements FromQuery, WithMapping, WithHeadings
{
    use Exportable;
    /**
    ...
    public function query()
    {
        ...
        return PindahTugas::query()->where('sekolah_id', $sekolah->id)->where('status', 2);
    }
