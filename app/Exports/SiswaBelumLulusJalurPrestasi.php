...
class SiswaBelumLulusJalurPrestasi implements FromQuery, WithMapping, WithHeadings
{
    /**
    ...
    public function query()
    {
        ...
        return Prestasi::query()->where('sekolah_id', $sekolah->id)->where('status', 2)->orderBy('jumlah', 'desc');
    }
