...
class SiswaBelumLulusJalurZonasi implements FromQuery, WithMapping, WithHeadings
{
    /**
    ...
    public function query()
    {
        ...
        return Zonasi::query()->where('sekolah_id', $sekolah->id)->where('status', 2)->orderBy('sekolah_id', 'desc');
    }
